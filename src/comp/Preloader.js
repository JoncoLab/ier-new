...
export class Preloader extends Component {
    ...
    constructor(props) {
        ...
        this.preloaderToggle = this.preloaderToggle.bind(this);
    }

    preloaderToggle() {
        this.setState({
            visibility: this.state. === 'none' ? 'flex' : 'none'
        });
    }

    render() {
        return (
            <div onChange={this.preloaderToggle} id="preloader" style={{display: this.state.visibility}}>
